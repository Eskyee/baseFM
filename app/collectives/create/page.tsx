...
export default function CreateCollectivePage() {
  ...
  const [type, setType] = useState<PromoterType>('collective');
    ...
    return (
      <div className="min-h-screen pb-20 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <p className="text-[#888] mb-8">Connect your wallet to create a profile for your collective, venue, label, or organization.</p>
          <WalletConnect />
        </div>
      </div>
    );
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-[#1A1A1A] border border-[#333] rounded-xl text-[#F5F5F5] placeholder-[#666] focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 bg-[#1A1A1A] border border-[#333] rounded-xl text-[#F5F5F5] placeholder-[#666] focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 resize-none transition-all"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-[#1A1A1A] border border-[#333] rounded-xl text-[#F5F5F5] placeholder-[#666] focus:outline-none focus:border-purple-500 transition-all"
              />
            </div>
            <div>
