    ...
    return (
      <div className="min-h-screen pb-24 flex items-center justify-center safe-area-all">
        <div className="text-center max-w-sm mx-auto px-6">
          ...
          <Link
            href="/"
            className="inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-[#3B82F6] text-white rounded-full font-semibold text-sm transition-all active:scale-[0.97] touch-target"
          >
