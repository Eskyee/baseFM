            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 bg-[#0052FF] rounded-full text-white text-sm font-semibold hover:bg-[#0040CC] transition-all active:scale-[0.98]"
                >
