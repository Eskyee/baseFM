      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section className="text-center mb-8">
          ...
          <p className="text-[#888] text-sm sm:text-base max-w-md mx-auto">
            Underground radio, events, tickets, services and bookings — all onchain. DJs, plug in your wallet to broadcast live, get paid instantly, and receive Crew Passes.
          </p>
        </section>
