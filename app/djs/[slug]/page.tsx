    ...
    <div className="min-h-screen pb-20">
      ...
      <div className="relative h-56 md:h-72">
        {hasCover ? (
          ...
          <div className="w-full h-full bg-gradient-to-br from-purple-900/50 via-[#1A1A1A] to-blue-900/50" />
        )}
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="relative -mt-20 mb-6">
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
            {/* Avatar */}
            <div className="w-28 h-28 sm:w-36 sm:h-36 rounded-full overflow-hidden border-4 border-[#0A0A0A] bg-[#1A1A1A] flex-shrink-0 ring-2 ring-purple-500/30">
              <img
              ...
              {dj.genres && dj.genres.length > 0 && (
                <div className="flex flex-wrap gap-1.5 mb-4">
                  {dj.genres.map((genre) => (
                    <span
                      key={genre}
                      className="px-2.5 py-1 bg-[#1A1A1A] text-[#888] text-xs rounded-full border border-[#333]"
                    >
                      {genre}
                    </span>
                  ))}
              ...
              <div className="flex items-center gap-3">
                {address && address.toLowerCase() !== dj.walletAddress.toLowerCase() && (
                  <button
                    ...
                    className={`px-5 py-2 rounded-full text-sm font-semibold transition-all active:scale-[0.97] ${
                      isFollowing
